...
const ACAO_SUGERIDA = {
  ...
  "Assédio Moral ou Sexual":                        { title: "Protocolo de prevenção e apuração de assédio, com canal de denúncia protegido", owner: "RH + Compliance" },
  "Más Relações Interpessoais":                     { title: "Mediação de conflitos e ações de fortalecimento de equipe",          owner: "RH + Lideranças" },
  "Falta de Apoio Social":                          { title: "Rodas de escuta e fortalecimento da rede de apoio entre colegas",     owner: "RH + Lideranças" },
  "Liderança Abusiva":                               { title: "Treinamento de liderança humanizada e avaliação 360° de gestores",   owner: "RH + Diretoria" },
  "Sobrecarga de Trabalho":                          { title: "Revisão de carga horária e redistribuição de tarefas",               owner: "RH + Gestores diretos" },
  "Monotonia ou Baixa Variedade das Atividades":     { title: "Rotação de tarefas e enriquecimento das atividades",                 owner: "Coordenadores" },
  "Trabalho Repetitivo":                             { title: "Avaliação ergonômica e pausas programadas",                          owner: "SST" },
  "Pressão por Metas":                               { title: "Revisão de metas e prazos por equipe",                               owner: "Coordenadores" },
  "Baixo Reconhecimento":                            { title: "Programa estruturado de reconhecimento e feedback",                  owner: "Gestão de Pessoas" },
  "Insegurança no Emprego":                          { title: "Comunicação transparente sobre estabilidade e planos da empresa",     owner: "Liderança executiva" },
  "Má Gestão de Mudanças":                           { title: "Plano de comunicação e capacitação para mudanças organizacionais",   owner: "RH + Liderança" },
  "Baixa Justiça Organizacional":                    { title: "Revisão de critérios de decisão e comunicação transparente",         owner: "RH + Compliance" },
};

const DIAGNOSTICO_RESULT_CONFIG = {
  copsoq:     { orientacao: "risco" },
  hse:        { orientacao: "risco" },
  entrevista: { orientacao: "risco" },
